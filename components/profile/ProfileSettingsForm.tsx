...
import { profileSettingsSchema, ProfileSettingsValues } from '@/lib/schemas/profile-settings-schema'
...
export function ProfileSettingsForm({ initialValues, onSubmitHandler }: ProfileSettingsFormProps) {
		...
		<div className="w-full max-w-lg p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
			...
			<form onSubmit={handleSubmit(onFormSubmit)} noValidate>
				...
				<div className="flex items-center gap-2 mb-6">
					...
					/>
					<label htmlFor="notifications" className="text-sm font-medium text-gray-700 select-none">
