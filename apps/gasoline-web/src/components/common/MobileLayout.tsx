...
export function MobileLayout({ children }: MobileLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex justify-center w-full overflow-hidden">
      <div className="w-full max-w-md bg-slate-50 flex flex-col h-screen shadow-2xl relative overflow-hidden">
        <OfflineBanner />
        {!isLoginPage && (
        ...
        <main
          className={`flex-1 overflow-y-auto ${isLoginPage ? "" : "pb-28"}`}
        >
